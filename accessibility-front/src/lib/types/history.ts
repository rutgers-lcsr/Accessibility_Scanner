...
// real backend categories: violations, passes, incomplete.
...
// The categories the history charts plot, in render order.
export const HISTORY_CATEGORIES = ['violations', 'incomplete', 'passes'] as const;
