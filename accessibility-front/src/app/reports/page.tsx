...
const columns = [
  {
    ...
    dataIndex: 'url',
    key: 'url',
    render: (text: string, record: ReportType) => <a href={`/reports?id=${record.id}`}>{text}</a>,
  },
  {
    title: 'Timestamp',
    dataIndex: 'timestamp',
  ...
  },
  {
    ...
    dataIndex: 'passed',
    key: 'passed',
    render: (text: string, record: ReportType) => <span>{record.report_counts.passes.total}</span>,
  },
  {
    title: 'Violations',
