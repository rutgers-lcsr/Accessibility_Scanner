            ...
            <Flex align="center" justify="center" className="w-full p-6">
                ...
                >
                    ...
                    <div className="text-sm text-gray-500">
                        ...
                        default tags will run every time, you can not remove default tags from a
                        website unless you change them here.
                    </div>
                    <div className="my-4" />
                    ...
                    />
                    <div className="text-sm text-gray-500">
                        Should new websites be automatically activated for automatic scanning per
                        rate limit when added, this can be overridden per website.
                    </div>
                    <div className="my-4" />
